...
globActPower <- as.numeric(dataSubset$Global_active_power)
globReactPower <- as.numeric(dataSubset$Global_reactive_power)
voltage <- as.numeric(dataSubset$Voltage)
png("plot4.png", width=480, height=480)
par(mfrow = c(2, 2))
plot(dateTime, globActPower, type="l", xlab="", ylab="Global Active Power", cex=0.2)
